      ...
      <form onSubmit={handleSubmit} className="flex-1 flex flex-col">
        ...
        >
          <label htmlFor="space-name" className="space-y-2 block">
            ...
            {name && !validation.valid ? (
              ...
              <span className="text-xs text-zinc-500 dark:text-zinc-400 block">
                A repository named{" "}
                <span className="font-mono">{name || "name"}.marlin</span> will
                be created
              </span>
            )}
          </label>
          ...
          <fieldset role="radiogroup" className="space-y-3">
            <legend className="text-sm font-medium dark:text-zinc-200">
              Visibility
            </legend>
            <div className="grid grid-cols-1 gap-3">
              ...
              >
                ...
                {isPrivate && (
                  <span
                    className="absolute top-3 right-3 h-2 w-2 rounded-full bg-zinc-900 dark:bg-zinc-100"
                    aria-hidden="true"
                  />
                )}
              </button>
