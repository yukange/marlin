        ...
        <div className="flex items-center gap-2 text-xs text-zinc-500 dark:text-zinc-400">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <time>
                  ...
                  {isInTrash && (
                    <span className="ml-1 text-zinc-400">(Deleted)</span>
                  )}
                </time>
              </TooltipTrigger>
              <TooltipContent
              ...
              >
                ...
                {note.deletedAt && (
                  <p>Deleted: {formatPreciseTime(note.deletedAt)}</p>
                )}
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
          {note.tags.length > 0 &&
            note.tags.map((tag) => {
              ...
              const isHighlighted = query.startsWith("#")
                ? query === `#${tag}`
            ...
            <DropdownMenuContent align="start" className="w-56">
              ...
              {isInTrash ? (
                ...
                <>
                  ...
                  <DropdownMenuItem
                    onClick={() => requirePro(handleShare)}
                  ...
                  <DropdownMenuItem
                    onClick={() => requirePro(() => onToggleTemplate?.(note))}
                    className="flex items-center"
                  >
        ...
        {!isExpanded && shouldShowExpandButton && (
          <footer
            className={cn(
              ...
              isInTrash
                ? "from-zinc-50 dark:from-zinc-950"
