  ...
  return (
    <>
      ...
      >
        ...
        >
          <header className="px-4 py-2 border-b border-zinc-100 dark:border-zinc-800 bg-white/50 dark:bg-zinc-900/50 backdrop-blur-sm flex items-center justify-between shrink-0">
