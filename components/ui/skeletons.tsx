            ...
            <div className="h-full w-full rounded-xl bg-zinc-100 dark:bg-zinc-900 p-4 flex flex-col">
                ...
                <div className="grid grid-cols-7 gap-1 mb-6">
                    {Array.from({ length: 35 }).map((_, i) => (
                        <div key={i} className="h-3 w-3 rounded-sm bg-zinc-200 dark:bg-zinc-800 animate-pulse" />
                    ))}
                </div>
                ...
                <div className="space-y-1.5 flex-1">
                    {Array.from({ length: 6 }).map((_, i) => (
                        <div key={i} className="h-7 w-full rounded bg-zinc-200 dark:bg-zinc-800 animate-pulse" style={{ width: `${60 + Math.random() * 40}%` }} />
                    ))}
                </div>
