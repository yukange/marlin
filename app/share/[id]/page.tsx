        ...
        <div className="container max-w-3xl mx-auto flex h-16 items-center justify-between px-4">
          ...
          >
            <Image
              ...
              width={24}
              height={24}
              className="hidden dark:block h-6 w-6 flex-shrink-0"
            />
            <Image
              src="/logo-dark.svg"
              alt="Marlin"
              width={24}
              height={24}
              className="block dark:hidden h-6 w-6 flex-shrink-0"
            />
            <Image
      ...
      <main className="container max-w-3xl mx-auto px-4 py-8 md:py-12">
        ...
        <footer className="mt-12 text-center text-sm text-zinc-500">
          <p>
            ...
            <Link
              href="/"
              className="font-medium hover:text-zinc-900 dark:hover:text-zinc-300 underline underline-offset-4"
            >
              Marlin Notes
            </Link>
          </p>
