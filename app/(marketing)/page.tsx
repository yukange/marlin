...
import { Github, Database, Cloud, Lock, Zap, FileText, Check, Search } from "lucide-react"
    ...
    <div className="flex min-h-screen flex-col bg-zinc-950 text-white font-sans">
      ...
      <main className="flex-1">
        ...
        <section className="container max-w-7xl mx-auto flex flex-col items-center gap-8 py-24 text-center md:py-32">
          <Badge variant="secondary" className="rounded-full px-4 py-1 text-sm font-normal bg-zinc-800 text-zinc-400 hover:bg-zinc-700">
          ...
          <div className="relative mt-12 w-full max-w-5xl group">
            ...
            <div className="absolute -bottom-8 left-0 right-0 text-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <p className="text-xs text-zinc-600 font-mono">Apple HIG compliant UI.</p>
            </div>
          </div>
          ...
          <div className="mt-2 w-full max-w-2xl rounded-lg bg-black border border-zinc-800 p-4 text-left shadow-xl">
            ...
            <pre className="font-mono text-sm text-zinc-50 overflow-x-auto">
              <span className="text-zinc-600">$</span> git commit -m &quot;New note from Marlin&quot;{"\n"}
              <span className="text-zinc-600">$</span> git push origin main{"\n"}
              <span className="text-zinc-600">#</span> <span className="text-green-400">Marlin does this for you, automatically.</span>
            </pre>
          </div>
        </section>
        ...
        <section className="border-y border-zinc-800 bg-zinc-900/50">
          <div className="container max-w-7xl mx-auto py-12 md:py-24 text-center">
            <p className="mb-8 text-sm font-semibold text-zinc-500 uppercase tracking-wider">Powered by the modern edge stack</p>
            <div className="flex flex-wrap justify-center gap-8 md:gap-16 grayscale opacity-70">
              <div className="flex items-center gap-2 font-semibold text-lg text-zinc-400"><Cloud className="h-6 w-6" /> Cloudflare Workers</div>
              <div className="flex items-center gap-2 font-semibold text-lg text-zinc-400"><Zap className="h-6 w-6" /> Next.js 15</div>
              <div className="flex items-center gap-2 font-semibold text-lg text-zinc-400"><Github className="h-6 w-6" /> GitHub</div>
              <div className="flex items-center gap-2 font-semibold text-lg text-zinc-400"><Database className="h-6 w-6" /> Dexie.js</div>
              <div className="flex items-center gap-2 font-semibold text-lg text-zinc-400"><FileText className="h-6 w-6" /> Tiptap</div>
            </div>
          </div>
        </section>

        {/* 4. Value Proposition */}
        <section id="features" className="container max-w-7xl mx-auto py-24 space-y-24 md:py-32">
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div className="relative flex items-center justify-center">
              ...
              <div className="relative font-mono text-sm text-zinc-400 bg-zinc-950/90 backdrop-blur border border-white/10 p-6 rounded-2xl shadow-2xl w-full max-w-md transform transition-transform hover:scale-[1.02]">
                <div className="flex items-center gap-2 text-zinc-500 mb-4 border-b border-zinc-800 pb-2"><Github className="h-4 w-4"/> repo-root</div>
               ...
               <div className="relative w-full max-w-md bg-zinc-950/90 backdrop-blur border border-white/10 rounded-2xl shadow-2xl p-6 space-y-4 transform -rotate-1 transition-transform duration-500 hover:rotate-0">
                 ...
                 <div className="relative">
                   ...
                   <div className="absolute inset-y-0 right-3 flex items-center">
                     <span className="text-[10px] text-green-500 bg-green-500/10 px-1.5 py-0.5 rounded border border-green-500/20 font-medium">0ms</span>
                   </div>
                 </div>
               </div>
            </div>
              ...
              <div className="relative md:col-span-1 md:row-span-2 group">
                ...
                <div className="relative h-full w-full rounded-3xl overflow-hidden shadow-2xl bg-zinc-900/20 backdrop-blur-sm border border-white/5">
                  ...
                  <div className="absolute bottom-0 left-0 p-8">
                    <h3 className="text-xl font-bold text-white mb-2">Activity & Structure</h3>
                    <p className="text-zinc-300 text-sm leading-relaxed">Visualize your coding habits with heatmaps and organize via tags.</p>
                  </div>
                </div>
              </div>
        ...
        <section className="container max-w-7xl mx-auto py-24 md:py-32 text-center">
          <h2 className="text-3xl font-bold tracking-tight mb-12 text-white">Secure by Architecture</h2>
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 text-sm font-medium text-zinc-400">
            <div className="p-6 rounded-xl border border-zinc-800 bg-zinc-950 shadow-sm w-64">
              <div className="mb-4 flex justify-center"><div className="h-12 w-12 rounded-full bg-zinc-800 flex items-center justify-center"><Zap className="h-6 w-6 text-zinc-400"/></div></div>
            ...
            <div className="p-6 rounded-xl border border-zinc-800 bg-zinc-950 shadow-sm w-64">
              <div className="mb-4 flex justify-center"><div className="h-12 w-12 rounded-full bg-zinc-800 flex items-center justify-center"><Lock className="h-6 w-6 text-zinc-400"/></div></div>
            ...
            <div className="md:hidden h-8 w-px bg-zinc-700" />
            <div className="p-6 rounded-xl border border-zinc-800 bg-zinc-950 shadow-sm w-64">
              <div className="mb-4 flex justify-center"><div className="h-12 w-12 rounded-full bg-zinc-800 flex items-center justify-center"><Github className="h-6 w-6 text-zinc-400"/></div></div>
          ...
          <p className="mt-8 text-zinc-400 max-w-2xl mx-auto">
            We use the <strong className="text-zinc-300">API Proxy Pattern</strong>. Your GitHub Access Token is encrypted and stored securely, never exposed to the client.
          </p>
        </section>
          ...
          <div className="container max-w-7xl mx-auto px-4 md:px-6">
            <div className="grid grid-cols-2 gap-8 md:grid-cols-4 text-center md:text-left">
              <div className="space-y-2">
                <h3 className="text-xs font-medium text-zinc-500 uppercase tracking-wider">Offline Support</h3>
                <p className="text-sm font-semibold text-zinc-300">Full Read/Write w/o Network</p>
              </div>
              <div className="space-y-2">
                <h3 className="text-xs font-medium text-zinc-500 uppercase tracking-wider">Storage Limit</h3>
                <p className="text-sm font-semibold text-zinc-300">GitHub Repo Size (100GB+)</p>
              </div>
              <div className="space-y-2">
                <h3 className="text-xs font-medium text-zinc-500 uppercase tracking-wider">Encryption</h3>
                <p className="text-sm font-semibold text-zinc-300">AES-256 Token Encryption</p>
              </div>
              <div className="space-y-2">
                <h3 className="text-xs font-medium text-zinc-500 uppercase tracking-wider">Tech Stack</h3>
                <p className="text-sm font-semibold text-zinc-300">Next.js 15, Dexie, Workers</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-zinc-900/50 py-24 md:py-32 border-y border-zinc-800">
          <div className="container max-w-3xl mx-auto space-y-12">
            <h2 className="text-3xl font-bold tracking-tight text-center text-white">FAQ</h2>
      ...
      <footer className="border-t border-zinc-800 bg-zinc-900/50 py-12 text-sm text-zinc-500">
        <div className="container max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6">
            <Link href="https://github.com/yukange/marlin" className="hover:text-white">Source Code</Link>
